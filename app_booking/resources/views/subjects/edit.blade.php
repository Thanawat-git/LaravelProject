                    ...
                    <table class="table" style="margin-top:20px">
                        <tbody>
                            <tr>
                                <td>Subject Code</td>
                                <td>
                                    <input type="text" class="form-control" name="Sub_code" value="{{ $subject->Sub_code }}"> </td>
                            </tr>
                            <tr>
                                <td>Subject Name</td>
                                <td><input type="text" class="form-control" name="Sub_name" value="{{ $subject->Sub_name }}"> </td>
                            </tr>
                        </tbody>
                    </table>
