                ...
                @csrf
                    <table class="table" style="margin-top:20px">
                        <tbody>
                            <tr>
                                <td>Queue Number</td>
                                <td><input type="text" class="form-control" required name="QNo"> </td>
                            </tr>
                            <tr>
                                <td>Status</td>
                                <td>
                            ...
                            <tr>
                                <td>Date</td>
                                <td><input type="date" class="form-control" required name="Date" placeholder="yyyy-mm-dd"> </td>
                            </tr>
                            <tr>
                                <td>Time Start</td>
                                <td><input type="time" class="form-control" required name="Time_Start" placeholder="hh:mm:ss"> </td>
                            </tr>
                            <tr>
                                <td>Time End</td>
                                <td><input type="time" class="form-control" required name="Time_End" placeholder="hh:mm:ss"> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="Sub_id" class="form-control">
                                        <option disabled selected hidden>กรุณาเลือกวิชา</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="Teacher_id" class="form-control">
                                        <option disabled selected hidden>กรุณาเลือกอาจารย์</option>
